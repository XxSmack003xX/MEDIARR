...
[![Version](https://img.shields.io/badge/version-1.6.3-35c5f0)](https://github.com/XxSmack003xX/MEDIARR/releases)
...
This README is written against the **v1.6.3 source in this repository**. Feature descriptions below are based on the routes and configuration that actually exist in `server.js`, not on a future roadmap.
